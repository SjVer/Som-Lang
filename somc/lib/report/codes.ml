(* File generated by gen_codes_ml.py on Thu Sep 28 17:10:57 2023. *)
...
let code_from_type_error : type_error -> int = function
  ...
  | Use_of_invalid_primitive _ -> 305
  | Has_no_symbol _ -> 306
...
let error_name_from_code = function
  ...
  | 305 -> Some ("type", "use of invalid primitive")
...
let explanation_from_code : int -> string option = function
  ...
  | 305 -> Some "This error is raised when it is attempted to use an invalid primitive operator, such as \"#wrong\"."
