(* File generated by gen_codes_ml.py on Tue Sep 20 15:52:47 2022. *)
...
let error_name_from_int = function
  ...
  | 204 -> Some ("syntax", "use of unbound symbol")
  | 205 -> Some ("syntax", "duplicate parameter")
  | 206 -> Some ("syntax", "other syntax error")
  | 301 -> Some ("type", "expected a different type")
  | 302 -> Some ("type", "could not infer type")
