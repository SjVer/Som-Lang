(* File generated by gen_codes_ml.py on Thu Aug 18 21:56:43 2022. *)
...
let int_from_syntax_error = function
  ...
  | Unclosed _ -> 205
  | Use_of_unbound _ -> 206
  | Duplicate_parameter _ -> 207
  | Other _ -> 208
...
let error_name_from_int = function
  ...
  | 205 -> Some "unclosed token"
  | 206 -> Some "use of unbound symbol"
  | 207 -> Some "duplicate parameter"
  | 208 -> Some "other syntax error"
