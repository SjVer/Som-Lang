(* File generated by gen_codes_ml.py on Thu Oct 13 21:21:22 2022. *)
...
let error_name_from_int = function
  ...
  | 306 -> Some ("type", "cannot import from non-module symbol")
  | 307 -> Some ("type", "could not infer type")
